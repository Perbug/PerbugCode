...
{
    const char* pszTimestamp = "Perbug coin is relaunching January 9th 2023";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 308000;
...
//        consensus.defaultAssumeValid = uint256S("0x1673fa904a93848eca83d5ca82c7af974511a7e640e22edc2976420744f2e56a"); //1155631
        ...
        genesis = CreateGenesisBlock(1673313782, 2000203969, 0x1e0ffff0, 1, 100000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x19af1dd845cf95d79285edccdad72c5d5a06f1526a5d194608d1213e8707ae47"));
        assert(genesis.hashMerkleRoot == uint256S("0x36ca91026b26558ac5df2e91ca5090ed45c667e3c24c51fba9258b4b237ca3b7"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("209.145.58.57", "209.145.58.57", true));
//        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
//        vSeeds.push_back(CDNSSeedData("perbugtools.com", "dnsseed.perbugtools.com"));
//        vSeeds.push_back(CDNSSeedData("perbugpool.org", "dnsseed.perbugpool.org"));
//        vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x19af1dd845cf95d79285edccdad72c5d5a06f1526a5d194608d1213e8707ae47"))
...
//            (721000, uint256S("0x198a7b4de1df9478e2463bd99d75b714eab235a2e63e741641dc8a759a9840e5"))
        ...
        chainTxData = ChainTxData{
            ...
            1673313782, // * UNIX timestamp of last known number of transactions
...
//        consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1673313782, 227604, 0x1e0ffff0, 1, 100000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9e126d8d86ce40c4ae149d59966a8d34e173c6a7117dfcbd7b052755e9a21aaa"));
        assert(genesis.hashMerkleRoot == uint256S("0x36ca91026b26558ac5df2e91ca5090ed45c667e3c24c51fba9258b4b237ca3b7"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("209.145.58.57", "209.145.58.57"));
//        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.perbug.loshan.co.uk", true));
//        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x9e126d8d86ce40c4ae149d59966a8d34e173c6a7117dfcbd7b052755e9a21aaa")),
        };
...
//        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1673313782, 5, 0x207fffff, 1, 100000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x593e7608bd302a899b2d49d62a1e7aec36fcce5d54bb2428407c61535e988036"));
        assert(genesis.hashMerkleRoot == uint256S("0x36ca91026b26558ac5df2e91ca5090ed45c667e3c24c51fba9258b4b237ca3b7"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x593e7608bd302a899b2d49d62a1e7aec36fcce5d54bb2428407c61535e988036"))
        };
