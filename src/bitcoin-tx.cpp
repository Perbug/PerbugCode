...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s perbug-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  perbug-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded perbug transaction") + "\n" +
              "  perbug-tx [options] -create [commands]   " + _("Create hex-encoded perbug transaction") + "\n" +
              "\n";
