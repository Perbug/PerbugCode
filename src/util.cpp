...
const char * const BITCOIN_CONF_FILENAME = "perbug.conf";
const char * const BITCOIN_PID_FILENAME = "perbug.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Perbug";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Perbug";
#else
    // Unix
    return pathRet / ".perbug";
#endif
#endif
}
